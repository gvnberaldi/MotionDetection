...
'lowFramerate', 'nightVideos', 'PTZ', 'shadow', 'thermal', 'turbulence']
    ...
    config.path.dataset = os.path.join(os.path.dirname(__file__), '..\\..\\..\\datasets\\CD2014\\dataset') # change to your dataset path
    config.path.train_txt = os.path.join(os.path.dirname(__file__), '..\\CDNet_2014\\data\\train.txt')
    config.path.test_txt = os.path.join(os.path.dirname(__file__), '..\\CDNet_2014\\data\\test.txt')
    config.path.val_txt = os.path.join(os.path.dirname(__file__), '..\\CDNet_2014\\data\\val.txt')
    config.path.txt = os.path.join(os.path.dirname(__file__), '..\\CDNet_2014\\data')
    config.path.outputs = os.path.join(os.path.dirname(__file__), '..\\CDNet_2014\\outputs')
    config.path.weights_save_dir = os.path.join(os.path.dirname(__file__), '..\\CDNet_2014\\outputs\\weights')
    config.path.best_weights_save_dir = os.path.join(os.path.dirname(__file__), '..\\CDNet_2014\\outputs\\best_weights')
    config.path.changemap = os.path.join(os.path.dirname(__file__), '..\\CDNet_2014\\outputs\\changemap')
    
    return config


def SBM_net_training_config():
    """Returns training configuration."""

    config = CDNet_2014_training_config()
    config.dataset_name = 'SMB_net'

    config.path.dataset = os.path.join(os.path.dirname(__file__), '..\\..\\..\\datasets\\SBMnet')  # change to your dataset path
    config.path.txt = os.path.join(os.path.dirname(__file__), '..\\SBMnet\\data')
    config.path.outputs = os.path.join(os.path.dirname(__file__), '..\\SBMnet\\outputs')
    config.path.changemap = os.path.join(os.path.dirname(__file__), '..\\SBMnet\\outputs\\changemap')
...
CONFIGS = {
    ...
    'SBMnet': SBM_net_training_config(),
